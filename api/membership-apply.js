...
/** Enrollment creates membership identity. Subscription pricing/invoicing is downstream. */
export default async function handler(req,res,options={}){
 ...
 try{
  ...
  /* Neon executes this as one atomic SQL statement. The application linkage is written by
     the INSERT itself, avoiding PostgreSQL's same-statement data-modifying-CTE snapshot trap. */
