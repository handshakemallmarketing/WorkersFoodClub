...
export const OPERATOR_TIER_SCOPES = {
  ...
  [OPERATOR_ADMIN_ACTOR_ID]: [
    'operator:fulfillment.manage','operator:refund.authorize','operator:refund.complete','operator:orders.read','operator:support.manage',
    OPERATOR_RELEASE_SCOPE,OPERATOR_CATALOG_SCOPE,OPERATOR_PROMOTIONS_SCOPE,OPERATOR_CREDIT_SCOPE,OPERATOR_PAYROLL_SCOPE,
  ],
};
