export const EXTERNAL_SERVICES=Object.freeze({
 ...
 email:{label:'Email',providers:{MAILERLITE:{label:'MailerLite',fields:['apiKey','fromEmail','fromName'],required:['apiKey','fromEmail']}},activation:'SETTINGS_MANAGE'},
 sms:{label:'Text / SMS',providers:{TWILIO:{label:'Twilio',fields:['accountSid','authToken','fromNumber'],required:['accountSid','authToken','fromNumber']}},activation:'SETTINGS_MANAGE'},
 ...
 observability:{label:'Error monitoring / observability',providers:{GENERIC:{label:'Generic endpoint',fields:['dsn'],required:['dsn']}},activation:'SETTINGS_MANAGE'}
});
